...
const variants = {
  ...
  secondary: {
    ...
    light:
      "bg-transparent border-2 border-haiintel-dark text-haiintel-dark hover:bg-gray-100",
  },
  gradient: {
    dark: "bg-gradient-to-r from-haiintel-blue to-haiintel-cyan text-white hover:opacity-90 shadow-intelligence",
    light:
      "bg-gradient-to-r from-haiintel-blue to-haiintel-cyan text-white hover:opacity-90 shadow-lg",
  },
  outline: {
    dark: "bg-transparent border-2 border-haiintel-cyan text-haiintel-cyan hover:bg-haiintel-cyan/10",
    light:
      "bg-transparent border-2 border-haiintel-blue text-haiintel-blue hover:bg-haiintel-blue/10",
  },
  ghost: {
