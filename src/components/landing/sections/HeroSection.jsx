      ...
      <div className="container mx-auto relative z-10 px-2 sm:px-0">
        <div className="text-center max-w-5xl mx-auto">
          ...
          <div className="mb-4 sm:mb-6 md:mb-8">
            {/* Main heading - Framer Motion animation */}
            <m.h1
              className="text-3xl xs:text-4xl sm:text-6xl md:text-7xl lg:text-8xl font-bold text-white mb-1 sm:mb-2 leading-tight"
            ...
            {/* Subtitle - Framer Motion animation */}
            <m.h2
