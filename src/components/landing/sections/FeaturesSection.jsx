...
const FeatureCard = memo(({ feature, isDarkMode }) => (
  ...
  >
    <div
      className={`w-14 h-14 rounded-xl bg-gradient-to-br ${feature.color} flex items-center justify-center text-white mb-5 group-hover:scale-110 transition-transform duration-150`}
    >
      <svg
        className="w-8 h-8"
        fill="none"
